...
// Add these at the end of scroll.h (before #endif)
extern UINT16 infinite_background_scroll;
extern UINT8  infinite_scroll_speed;
extern UINT8  infinite_scroll_direction;
extern UINT8  infinite_scroll_active;
